myApp.registerCtrl('file_department_controller', [
    'file_service',
    '$q',
    '$rootScope',
    '$filter',
    ...
    function (file_service, $q, $rootScope, $filter, $window, $location) {
        ...
        function load_department_service(department_id, department_grade) {
            var dfd = $q.defer();
            file_service.load_department(department_id, department_grade).then(
                function (res) {
        ...
        ctrl.chooseDepartment = function (department) {
            ctrl.currentDepartment = department;
            $location.search('id', department._id);
        ...
        ctrl.prepareInsertFolder = function (type) {
            ...
            ctrl._insert_folder_value = {
                ...
                version: '1.0',
                type: type,
                department: ctrl.currentDepartment.id,
                isGeneral: false,
                project: '',
                share: [],
                value: {},
        ...
        ctrl.prepareUpdate = function (value) {
            ...
            ctrl._update_folder_value.tab = 'department';
        };
