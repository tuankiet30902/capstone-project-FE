myApp.registerCtrl('file_project_controller', [
    'file_service',
    '$q',
    '$rootScope',
    '$filter',
    '$window',
    '$location',
    function (file_service, $q, $rootScope, $filter, $window, $location) {
        var ctrl = this;
        /**declare variable */
        ...
        /** init variable */
        {
            ctrl._ctrlName = 'file_department_controller';
        ...
        ctrl.loadProject = function (val) {
            ...
            return $rootScope.statusValue.execute(ctrl._ctrlName, "File", "loadProject", load_project_service);
        }
        ...
        function load_project_service() {
            ...
            file_service.load_project(undefined, ctrl.numOfItemPerPage_Project, ctrl.offset_Project, ctrl.sort_Project.query).then(function (res) {
                ctrl.Projects = res.data;
                let currentId = $location.search().id;
                if (ctrl.Projects && currentId) {
                    let currentProject = ctrl.Projects.find(prj => prj._id === currentId);
                    if (currentProject) {
        ...
        ctrl.chooseProject = function (project) {
            ...
            $location.search('id', project._id);
            ctrl.load_list_file_created();
        };
        /** END Choose Deparment */
        ...
        ctrl.prepareInsertFolder = function (type) {
            ...
            ctrl._insert_folder_value = {
                ...
                department: '',
                isGeneral: false,
                project: ctrl.currentProject._id,
                share: [],
                value: '',
        ...
        ctrl.prepareUpdate = function (value) {
            ...
            ctrl._update_folder_value.tab = 'project';
        };
